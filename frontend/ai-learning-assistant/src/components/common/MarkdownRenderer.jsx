    ...
    <div className="text-neutral-700">
        <ReactMarkdown
            ...
            components={{
                ...
                a: ({ node, ...props }) => <a className="text-[#007bff] hover:underline" {...props} />,
                ...
                blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-neutral-200 pl-4 italic text-neutral-500 my-4" {...props} />,
                ...
                pre: ({ node, ...props }) => <pre className="bg-neutral-800 text-white p-3 rounded-md font-mono overflow-x-auto text-sm my-4" {...props} />
            }}
        >
            {content}
        </ReactMarkdown>
